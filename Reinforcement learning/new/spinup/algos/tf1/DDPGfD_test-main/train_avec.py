...
def get_args():
    ...
    arg('--env_name', type=str, default='HalfCheetah-v2', help='environment name')
    # train:
    arg('--seed', type=int, default=0, help='')
    arg('--num_frames', type=int, default=50000, help='')
    arg('--memory_size', type=int, default=100000*100, help='')
    arg('--batch_size', type=int, default=128, help='')
    #arg('--batch_size', type=int, default=128, help='')
    arg('--ou_noise_theta', type=float, default=1.0*0, help='')
    arg('--ou_noise_sigma', type=float, default=0.1*0, help='')
    arg('--initial_random_steps', type=int, default=10000, help='')
    arg('--n_step', type=int, default=3, help='')
    arg('--pretrain_step', type=int, default=1000*10, help='')
...
def main():
  for args.seed in range(0,5):
    ...
    agent.df.to_csv("Progress/HalfCheetah_progress_s%d.csv" % args.seed)
