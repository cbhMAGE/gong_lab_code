...
class DDPGfDAgent:
    ...
    def __init__(
        ...
        self.df = pd.DataFrame(columns=['Epoch','TotalEnvInteracts','AverageEpRet'],dtype=float)
    ...
    def train(self, num_frames: int, plotting_interval: int = 200):
        ...
        while Epoch< 500:
          ...
          turn_score=[]
          #k = min(Epoch%3+5,20)
          while self.total_step - last_time < period or self.total_step == 0:
            self.total_step += 1
            ...
            if (
                ...
                # reporting
                if self.total_step % plotting_interval == 0 and flag:
          ...
          last_time = self.total_step
          self.df.loc[Epoch] = [Epoch, 40000*(Epoch+1), statistics.mean(turn_score)]
          print(self.df)
