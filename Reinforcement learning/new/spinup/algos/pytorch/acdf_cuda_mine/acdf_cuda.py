...
def acdf(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    for epoch in range(epochs):
        #if epoch > 100: LLLL = 1
        buf = ACDFBuffer(obs_dim, act_dim, int(LLLL*local_steps_per_epoch), gamma, lam)
        #diedown = diedown * 0.9
        ...
        for t in range(int(local_steps_per_epoch*LLLL)):
            ...
            timeout = ep_len == max_ep_len
            terminal = d or timeout
            epoch_ended = t==int(local_steps_per_epoch*LLLL)-1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='AMT_Swimmer_Contrast_ACFD')
