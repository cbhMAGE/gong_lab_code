...
def main():
    ...
    #environments = ['Hopper', 'Ant']
    #environments = ['Hopper', 'Ant', 'Swimmer', 'InMoov', 'Humanoid', 'Jaka']
    environments = ['Ant', 'Hopper', 'Humanoid', 'Swimmer','InMoov' ]
    #environments.sort()
    ...
    root_path="/home/tete/work/new/data_plot/Automatica/Birch_Ablation_Study/"
    #root_path="/home/tete/work/new/data_plot/Automatica/Ours/"
