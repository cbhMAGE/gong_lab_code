...
"""autogenerated by genpy from openpose/anglegoalActionResult.msg. Do not edit."""
import sys
...
class anglegoalActionResult(genpy.Message):
  ...
  _type = "openpose/anglegoalActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','openpose/anglegoalResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = openpose.msg.anglegoalResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = openpose.msg.anglegoalResult()
