...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.target.plane_poses:
        ...
        _x = _v6
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
      buff.write(_struct_b.pack(self.target.operation))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.target.operation,) = _struct_b.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.support_surfaces = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.grasps:
        ...
        _v182 = _v181.header
        buff.write(_struct_I.pack(_v182.seq))
        _v183 = _v182.stamp
        _x = _v183
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v182.frame_id
        ...
        _v193 = _v192.header
        buff.write(_struct_I.pack(_v193.seq))
        _v194 = _v193.stamp
        _x = _v194
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v193.frame_id
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.grasps:
        ...
        _v251 = _v250.header
        buff.write(_struct_I.pack(_v251.seq))
        _v252 = _v251.stamp
        _x = _v252
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v251.frame_id
        ...
        _v261 = _v260.header
        buff.write(_struct_I.pack(_v261.seq))
        _v262 = _v261.stamp
        _x = _v262
        buff.write(_struct_2I.pack(_x.secs, _x.nsecs))
        _x = _v261.frame_id
