...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3d.pack(_x.request.num_planning_attempts, _x.request.allowed_planning_time, _x.request.max_velocity_scaling_factor, _x.request.max_acceleration_scaling_factor))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.request.num_planning_attempts, _x.request.allowed_planning_time, _x.request.max_velocity_scaling_factor, _x.request.max_acceleration_scaling_factor,) = _struct_i3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
