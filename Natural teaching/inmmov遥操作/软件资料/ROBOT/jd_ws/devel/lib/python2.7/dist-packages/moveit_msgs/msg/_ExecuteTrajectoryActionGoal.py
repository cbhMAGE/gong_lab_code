...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.goal.trajectory.joint_trajectory.header.seq, _x.goal.trajectory.joint_trajectory.header.stamp.secs, _x.goal.trajectory.joint_trajectory.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.goal.trajectory.multi_dof_joint_trajectory.header.seq, _x.goal.trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.goal.trajectory.multi_dof_joint_trajectory.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.trajectory.joint_trajectory.header.seq, _x.goal.trajectory.joint_trajectory.header.stamp.secs, _x.goal.trajectory.joint_trajectory.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.goal.trajectory.multi_dof_joint_trajectory.header.seq, _x.goal.trajectory.multi_dof_joint_trajectory.header.stamp.secs, _x.goal.trajectory.multi_dof_joint_trajectory.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
