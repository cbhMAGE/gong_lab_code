...
if("TRUE" STREQUAL "TRUE")
  set(moveit_experimental_SOURCE_PREFIX /home/pn/jd_ws/src/moveit/moveit_experimental)
  set(moveit_experimental_DEVEL_PREFIX /home/pn/jd_ws/devel)
  ...
  set(moveit_experimental_INSTALL_PREFIX /home/pn/jd_ws/install)
...
if(NOT "/home/pn/jd_ws/devel/include;/home/pn/jd_ws/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/indigo/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(moveit_experimental_INCLUDE_DIRS "")
  set(_include_dirs "/home/pn/jd_ws/devel/include;/home/pn/jd_ws/src/moveit/moveit_experimental/collision_distance_field/include;/opt/ros/indigo/include;/usr/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pn/jd_ws/src/moveit/moveit_experimental/${idir}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>' to fix it.")
    endif()
    _list_append_unique(moveit_experimental_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "moveit_collision_distance_field;collision_detector_hybrid_plugin;/opt/ros/indigo/lib/liboctomap.so;/opt/ros/indigo/lib/liboctomath.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_iostreams.so;/usr/lib/x86_64-linux-gnu/libpthread.so;/usr/lib/x86_64-linux-gnu/liburdfdom_sensor.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model_state.so;/usr/lib/x86_64-linux-gnu/liburdfdom_model.so;/usr/lib/x86_64-linux-gnu/liburdfdom_world.so;/usr/lib/x86_64-linux-gnu/libconsole_bridge.so")
...
set(depends "moveit_core;geometric_shapes;shape_tools;eigen_stl_containers;eigen_conversions;moveit_msgs;kdl_parser;pluginlib")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${moveit_experimental_dep}_FOUND)
      find_package(${moveit_experimental_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${moveit_experimental_dep} REQUIRED ${depend_list})
  endif()
