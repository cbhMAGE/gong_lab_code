...
if(NOT "include;/opt/ros/indigo/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(moveit_experimental_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/indigo/include;/usr/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pn/jd_ws/install/${idir}'.  Ask the maintainer 'Sachin Chitta <robot.moveit@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>' to fix it.")
    endif()
