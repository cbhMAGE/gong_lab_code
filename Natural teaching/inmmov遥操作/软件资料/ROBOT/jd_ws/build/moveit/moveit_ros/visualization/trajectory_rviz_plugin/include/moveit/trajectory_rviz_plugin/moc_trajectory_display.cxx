...
static const char qt_meta_stringdata_moveit_rviz_plugin__TrajectoryDisplay[] = {
...
const QMetaObjectExtraData moveit_rviz_plugin::TrajectoryDisplay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject moveit_rviz_plugin::TrajectoryDisplay::staticMetaObject = {
    { &rviz::Display::staticMetaObject, qt_meta_stringdata_moveit_rviz_plugin__TrajectoryDisplay,
      qt_meta_data_moveit_rviz_plugin__TrajectoryDisplay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &moveit_rviz_plugin::TrajectoryDisplay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_moveit_rviz_plugin__TrajectoryDisplay))
